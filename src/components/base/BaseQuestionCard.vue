  ...
  <el-card :id="props.question._id">
    <template #header>
      <el-row justify="space-between" align="middle">
        <span v-if="props.question.score" class="score">{{ props.question.score }} điểm</span>
        <div v-else></div>
        <el-button :type="flag ? 'danger' : 'info'" :icon="Flag" size="large" circle text @click="onFlag" />
      </el-row>
    </template>
      ...
      <el-col class="body">
        ...
        <el-row v-if="props.question.is_multiple_answers" class="answer">
          <el-checkbox-group v-model="selected">
            <el-row v-for="answer in props.question.answers" :key="answer._id" class="answer-item">
        ...
        <el-row v-else :gutter="20" class="answer">
          <el-radio-group v-model="selected">
            <el-col v-for="answer in props.question.answers" :key="answer._id" class="answer-item">
